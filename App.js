          ...
          <View style={styles.modal} >
            <View style={[styles.modalContainer, {marginTop: showOnline? -onlineHeight:0}]} >
              ...
              <Touchable disabled={disabled} style={styles.button} onPress={this.onClear} >
                <Image style={[styles.buttonIcon, disabled && styles.disabled]} source={require('./app/images/reload.png')} />
              ...
              <Touchable style={styles.button} onPress={this.onCreate} >
                <Image style={styles.buttonIcon} source={require('./app/images/shuffle.png')} />
                <Text style={styles.buttonText} >{I18n.t('newgame')}</Text>
              </Touchable>
              {/* <Touchable style={styles.button} onPress={this.onToggleRecord} >
                <Image style={styles.buttonIcon} source={require('./app/images/rank.png')} />
            ...
            <View style={styles.footer} >
              <Touchable style={styles.button} onPress={this.onShare} >
                <Image style={[styles.buttonIcon, styles.disabled]} source={require('./app/images/share.png')} />
              </Touchable>
              <Touchable style={styles.button} onPress={this.onCloseModal} >
                <Image style={[styles.buttonIcon, styles.disabled]} source={require('./app/images/close.png')} />
              </Touchable>
              <Touchable style={styles.button} onPress={this.onRate} >
                <Image style={[styles.buttonIcon, styles.disabled]} source={require('./app/images/rate.png')} />
              </Touchable>
            </View>
          </View>
        </Modal>
